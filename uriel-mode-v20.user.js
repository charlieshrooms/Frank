// ==UserScript==
// @name         BetFury Dice Bot - Uriel Mode V20
// @version      20.0
// @description  Uriel V20: V19 hardening + cleaner presets + live stats HUD
...
(function () {
  ...
  function drawUI() {
    ...
    leftPanel.innerHTML = `
      <div style="color:#0f0;font-weight:bold;border-bottom:1px solid #0f0;padding-bottom:6px;margin-bottom:8px;font-size:12px;">&gt; URIEL CONSOLE V20</div>
  ...
  // Persistent guard: re-inject HUD if SPA wipes it
  setInterval(() => {
    if (!document.getElementById('v20-main-btn')) tryInit();
  }, 2000);
